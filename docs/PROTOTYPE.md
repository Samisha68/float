# Float — Hackathon Prototype Reference

> **Status: archived reference, not current product intent.**
> This is the original README for the MONOLITH Solana Mobile Hackathon build (March 2026):
> a consumer mobile lending app with collateralised installment loans and AI-agent
> micro-loans. Float is now building on-chain short-term working-capital credit for
> businesses — see the root [README.md](../README.md).
>
> Kept because the on-chain patterns, the Mobile Wallet Adapter integration and the agent
> plumbing are real, working reference material. The product described below is not.
...
- [docs/AI_MICRO_LENDING_SETUP.md](../docs/AI_MICRO_LENDING_SETUP.md)
